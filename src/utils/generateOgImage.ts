...
export async function generateOgImage(title: string, subtitle: string) {
    ...
    const markup = html`
        <div style="background-color: #8785A2; width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; position: relative; font-family: 'Inter';">
            
            <div style="display: flex; position: absolute; top: -150px; right: -50px; width: 600px; height: 600px; background-image: linear-gradient(135deg, rgba(255, 199, 199, 0.45), rgba(135, 133, 162, 0)); border-radius: 50%;"></div>
            <div style="display: flex; position: absolute; bottom: -150px; left: -50px; width: 600px; height: 600px; background-image: linear-gradient(45deg, rgba(255, 226, 226, 0.4), rgba(135, 133, 162, 0)); border-radius: 50%;"></div>
            ...
            <div style="display: flex; flex-direction: column; justify-content: space-between; padding: 80px; width: 100%; height: 100%;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: flex-end; width: 100%;">
                    <div style="display: flex; flex-direction: column; gap: 8px;">
                        <span style="color: #FFE2E2; font-size: 28px; font-weight: 400;">Academic Portfolio</span>
                        <span style="color: #F6F6F6; font-size: 32px; font-weight: 700;">Jun Zhou</span>
                    </div>
                    <div style="display: flex; align-items: center; justify-content: center; width: 80px; height: 80px; background-color: #ffffff; border-radius: 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
                        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#8785A2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
